...
from wechat_login import wc_login
...
def area_top10(fri_infos):
    ...
    plt.ylabel(u'省会好友人数')  # 设置纵坐标标签
    prov_title = u'微信好友区域Top10'
    plt.title(prov_title)    # 设置标题
    plt.savefig(desc_full + u'/微信好友区域Top10')  # 保存图片
    ...
    plt.ylabel(u'城市好友人数')  # 设置纵坐标标签
    city_title = u'微信好友城市Top10'
    plt.title(city_title)       # 设置标题
    plt.savefig(desc_full + u'/微信好友城市Top10')
    # 显示
    plt.show()
